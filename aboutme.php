    ...
    <body>
        ...
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="#" class="nav__logo">Priyanshi</a>
                </div>
        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                <div class="home__data">
                    <h1 class="home__title">Hi,<br>I'am <span class="home__title-color">Priyanshi</span><br>IT Undergraduate</h1>

                    <a href="#contact" class="button">Contact</a>
                </div>

                <div class="home__social">
                    <a href="https://www.linkedin.com/in/priyanshi-setia-1b99081b7/" class="home__social-icon"><i class='bx bxl-linkedin'></i></a>
                    <!-- <a href="" class="home__social-icon"><i class="fa fa-youtube-play"></i></a>-->
                    <a href="https://github.com/priyanshi47" class="home__social-icon"><i class='bx bxl-github' ></i></a>
                </div>
            ...
            <section class="about section " id="about">
                ...
                <div class="about__container bd-grid">
                    ...
                    <div>
                        <h2 class="about__subtitle">I'am Priyanshi</h2>
                        <p class="about__text">Currently persuing BE. in Information Technology from MBM Enginnering College.
            ...
            <section class="contact section" id="contact">
                ...
                <div class="contact__container bd-grid">
                    <!-- <form action="" class="contact__form">
                        ...
                        <a href="mailto:setiapriyanshi9@gmail.com"><input type="button" value="Send Mail" class="contact__button button" style="background-color:skyblue ; border:2px solid black; color:black ; width:500px"></a>
        ...
        <!--===== FOOTER =====-->
        <footer class="footer">
            <p class="footer__title">Priyanshi Setia </p>
